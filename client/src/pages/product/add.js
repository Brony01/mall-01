...
class ProductAdd extends Component {
    ...
    constructor(props) {
        ...
        this.title = (
            <span><Icon type="arrow-left" onClick={() => {
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields(async (err, values) => {
            if (!err) {
                ...
                const res = await (this.isUpdate ? reqProductUpdate({
                    ...params,
                    _id: this.oldData._id
                }) : reqAddProduct(params))
                if (res.status === 0) {
            ...
            <Card title={this.title}>
                <Form {...formItemLayout} onSubmit={this.handleSubmit}>
                    ...
                    <Form.Item label="商品分类">
                        ...
                        })(<Cascader placeholder='请选择商品分类' options={productClassList}
                                     loadData={this.productLoadData}/>)}
                    </Form.Item>
                    <Form.Item
                        label="商品详情">
